...
The goal of this assignement is to provide a clear document to reproduce the value factor of the famous 5-Fama_French factor model, which aim to explain the cross-section of expected returns. 

The assignement starts with the severall importing procedure. All imported packages are essential for the reproduction of this assignement. 

## 0. Importing procedures
...
symbols = tf.download_data(domain="constituents", index="Dow Jones Industrial Average")
